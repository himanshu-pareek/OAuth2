...
public class JWTVerifier<T> {
    ...
    public JWTVerifier<T> verify(PublicKeyEntry publicKeyEntry) throws InvalidJWTException, NoSuchAlgorithmException, SignatureException, InvalidKeyException, JsonProcessingException {
        return this.verify(CryptoUtil.publicKeyFromEntry(publicKeyEntry));
    }
